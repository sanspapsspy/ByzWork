...
//Функция setKthBit(int a, int k) принимает два аргумента : число a и позицию бита k(1 - based indexing).
...
//
//Например, если ввести a = 5 и k = 3, то результатом будет 13, так как 5 в двоичной системе записи равно 101, а после установки 3 - го бита в 1 получается 1101, что равно 13 в десятичной системе.